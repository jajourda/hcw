...
export default function BibVideoListItem({ video }: IBibVideoListItemProps) {
  ...
  return (
    <div>
      ...
      >
        <Link
          href="/bibleinbitsvideo/[youtube]"
          as={`/bibleinbitsvideo/${video.youtube}`}
        >
            ...
            <div className="bg-white dark:bg-gray-800 w-full p-4">
              ...
              <div className="flex items-center mt-4">
                <a href="#" className="block relative">
                  <img
                    alt="profil"
                    src="https://lh3.googleusercontent.com/a-/AOh14Gho5YK2yVvF9gdv12O0QEdU_KN7kEcaDg-SkxsfHyk=s96-c-rg-br100"
                    className="mx-auto object-cover rounded-full h-10 w-10 "
                  />
                </a>
                <div className="flex flex-col justify-between ml-4 text-sm">
                  <p className="text-gray-800 dark:text-white">Joshua Linog</p>
