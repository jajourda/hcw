    ...
    <div className="bg-white dark:bg-gray-800 flex relative z-20 items-center overflow-hidden">
        <div className="container mx-auto px-6 flex relative py-16">
            <div className="sm:w-2/3 lg:w-2/5 flex flex-col relative z-20">
                ...
                <h1 className="text-left font-bebas-neue uppercase text-6xl sm:text-8xl font-black flex flex-col leading-none dark:text-white text-gray-800">
                    Gather
                    <span className="text-5xl sm:text-7xl">
                        Together
                    </span>
                </h1>
                <p className="text-left text-sm sm:text-base text-gray-700 dark:text-white">
                    We want to equip bodies of disciples to conduct gatherings led by the Spirit of the Messiah, based on the foundational elements of the Torah.
                </p>
                <div className="flex mt-8">
                    <a href="/bibleinbits" className="uppercase py-2 px-4 rounded-lg bg-purple border-2 border-transparent text-white text-md mr-4 hover:bg-purple">
                        Bible in Bits
                    </a>
                    <a href="#" className="uppercase py-2 px-4 rounded-lg bg-transparent border-2 border-green text-green dark:text-white hover:bg-green hover:text-white text-md">
                        Watch
                    </a>
                </div>
            </div>
