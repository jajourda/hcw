...
export default async function handler(req, res) {
  ...
  const data = await fetch(
    "http://api.biblia.com/v1/bible/content/LEB.html.json?passage=" +
      scripture +
      "&fullText=true&citation=true&style=oneVersePerLineFullReference&key=7166e434ad5dd762b8c721209c878d5d"
  );
  try {
